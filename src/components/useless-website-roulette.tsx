...
// Add a type definition for the website object
...
export default function UselessWebsiteRoulette() {
  ...
  // Fix: specify the correct type for randomWebsite state
  const [randomWebsite, setRandomWebsite] = useState<UselessWebsite | null>(null)
